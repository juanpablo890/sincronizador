...
public class RangoAVLDAO {
    ...
    public boolean insert(RangoAVL d, Connection DBConnection, PreparedStatement prepareStatement) {
    ...
    public boolean update(RangoAVL d, Connection DBConnection, PreparedStatement prepareStatement) {
    ...
    public RangoAVL select (RangoAVL d, Connection DBConnection, PreparedStatement prepareStatement) {
